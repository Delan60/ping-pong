...
import { BALL_INITIAL_SPEED_PX_PER_SEC, PLAYFIELD_WIDTH_PX, PLAYFIELD_HEIGHT_PX, BALL_SIZE_PX } from '../gameConfig';
...
export function useBallMovement(): BallMotionState {
  ...
  return {
    ...
    setVelocity: (vx, vy) => { velocityRef.current.vx = vx; velocityRef.current.vy = vy; },
